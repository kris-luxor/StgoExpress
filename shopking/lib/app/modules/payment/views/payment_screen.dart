                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          couponController.applyCouponStatus
                                              ...
                                              : TextWidget(
                                                  text: 'You saved'.tr +
                                                      ' ${authController.settingModel!.data!.siteDefaultCurrencySymbol.toString()}${couponController.applyCouponModel.value.data?.convertDiscount!.toStringAsFixed(int.parse(authController.settingModel!.data!.siteDigitAfterDecimalPoint.toString())) ?? 0}',
                                                  color: AppColor.textColor,
                                                  fontSize: 12.sp,
                                                  fontWeight: FontWeight.w400,
                                                ),
