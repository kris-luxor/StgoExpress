...
class OTPScreen extends StatefulWidget {
  OTPScreen({super.key, this.emailOrPhone, this.countryCode});
                                ...
                                InkWell(
                                  onTap: () {
                                    swapController.isShowEmailField.value
                                        ? otpController.resendOTPWithEmail(
                                            email: widget.emailOrPhone.toString())
                                        : otpController.resendOTPWithPhone(
                          ...
                          PrimaryButton(
                            ...
                            onTap: () {
                              if (formkey.currentState!.validate()) {
                                swapController.isShowEmailField.value
                                    ? otpController.verifyOTPWithEmail(
                                        email: widget.emailOrPhone.toString(),
                                        token: tokenTextController.text)
                                    : otpController.verifyOTPWithPhone(
                                        phone: widget.emailOrPhone.toString(),
                                        country_code:
                                            widget.countryCode.toString(),
                                        token: tokenTextController.text);
